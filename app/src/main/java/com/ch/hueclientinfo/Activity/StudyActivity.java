...
public class StudyActivity extends AppCompatActivity implements View.OnClickListener{
            ...
            case DownloadSuccess:
                ...
                adapter.setItemClickListener(new MyAdapter.ItemClickListener() {
                    ...
                    public void onItemClicked(View view, int position) {
                        ...
                        intent.setClass(StudyActivity.this,ContentActivity.class);
    ...
    private void init() {
        ...
        RecyclerView.LayoutManager manager = new LinearLayoutManager(StudyActivity.this,LinearLayoutManager.VERTICAL,false);
    ...
    private void downloadinfo(String page){
        final SweetAlertDialog dialog = new SweetAlertDialog(StudyActivity.this,SweetAlertDialog.PROGRESS_TYPE);
        ...
        util.download("http://www.hue.edu.cn/webapp/public/cates/414&page=1?page="+page, new DownloadUtil.OnDownloadListener() {
            @Override
    ...
    private void refreah() {
        ...
        refreshLayout.setOnMultiPurposeListener(new SimpleMultiPurposeListener(){
            ...
            public void onHeaderPulling(RefreshHeader header, float percent, int offset, int headerHeight, int extendHeight) {
                TastyToast.makeText(StudyActivity.this,"下拉刷新",TastyToast.LENGTH_SHORT,TastyToast.INFO).show();
            ...
            public void onHeaderFinish(RefreshHeader header, boolean success) {
                TastyToast.makeText(StudyActivity.this,"刷新成功",TastyToast.LENGTH_SHORT,TastyToast.SUCCESS).show();
                super.onHeaderFinish(header, success);
            }
            @Override
            public void onRefresh(RefreshLayout refreshLayout) {
                TastyToast.makeText(StudyActivity.this,"正在刷新",TastyToast.LENGTH_SHORT,TastyToast.INFO).show();
