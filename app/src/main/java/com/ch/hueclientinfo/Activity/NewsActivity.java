...
public class NewsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        RecyclerView.LayoutManager manager = new LinearLayoutManager(NewsActivity.this,LinearLayoutManager.VERTICAL,false);
    ...
    private void downloadinfo(String page){
        final SweetAlertDialog dialog = new SweetAlertDialog(NewsActivity.this,SweetAlertDialog.PROGRESS_TYPE);
        ...
        util.download("http://www.hue.edu.cn/webapp/public/cates/410&page=1?page="+page, new DownloadUtil.OnDownloadListener() {
            @Override
    ...
    private void refreah() {
        ...
        refreshLayout.setOnMultiPurposeListener(new SimpleMultiPurposeListener(){
            ...
            public void onHeaderPulling(RefreshHeader header, float percent, int offset, int headerHeight, int extendHeight) {
                TastyToast.makeText(NewsActivity.this,"下拉刷新",TastyToast.LENGTH_SHORT,TastyToast.INFO).show();
            ...
            public void onHeaderFinish(RefreshHeader header, boolean success) {
                TastyToast.makeText(NewsActivity.this,"刷新成功",TastyToast.LENGTH_SHORT,TastyToast.SUCCESS).show();
                super.onHeaderFinish(header, success);
            }
            @Override
            public void onRefresh(RefreshLayout refreshLayout) {
                TastyToast.makeText(NewsActivity.this,"正在刷新",TastyToast.LENGTH_SHORT,TastyToast.INFO).show();
